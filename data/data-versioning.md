...
* [IDC REST API](../api/README.md) and [MCP server](../mcp/README.md): language-independent access to the same structured cohort filters as the Portal, plus a guarded SQL surface for relational and aggregate queries
