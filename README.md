...
* **AI assistants**: give Claude or any other agent access to IDC — with the [hosted MCP server](mcp/README.md) or the [IDC agent skill](agents/skill/README.md) — to discover, subset, and download IDC data in plain conversation (see [Using IDC with an AI assistant](agents/README.md))
