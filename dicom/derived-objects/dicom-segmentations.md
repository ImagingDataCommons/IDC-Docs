...
{% hint style="info" %}
SEG-specific metadata attributes are available in the table views maintained by IDC. See details [here](../../data/organization-of-data/deprecated-functionality/organization-of-data-v1.md).
{% endhint %}
