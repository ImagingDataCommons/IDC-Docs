...
The steps concerning creating a Google Cloud project and setting up billing are covered in Part 1 of  our ["Getting started" tutorial series](https://github.com/ImagingDataCommons/IDC-Tutorials/tree/master/notebooks/getting\_started), and in [this short video tutorial](https://youtu.be/i08S0KJLnyw).
