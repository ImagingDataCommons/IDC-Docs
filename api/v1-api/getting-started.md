...
This [Google Colab notebook](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/idc_api/How_to_Use_the_IDC_API.ipynb) serves as an interactive tutorial to accessing the IDC API using Python.
